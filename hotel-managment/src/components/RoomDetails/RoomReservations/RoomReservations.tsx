...
export const RoomReservartions = () => {
    ...
    return (
        <div className={styles["container"]}>
            ...
            {calendarData.from && calendarData.to && <Button onClick={() => setReserveModal(true)}>Make a Reservation</Button>}

            {calendarData.from != undefined || (calendarData.to != undefined && <p>Select two dates</p>)}
        </div>
    );
};
